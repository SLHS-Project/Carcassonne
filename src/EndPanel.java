...
public class EndPanel extends JPanel implements MouseListener, ActionListener, KeyListener{
    ...
    public EndPanel(CarcassonneGraphic parent) throws IOException
    {
        this.parent = parent;
    ...
    public void paint(Graphics g)
    {
        ...
        Font f1 = new Font("Times New Roman", 0, getHeight()*40/1080);
        g.setFont(f1);
        g.drawString(this.parent.winner.toString() + " is winner", getWidth()/2, getHeight()/2);
